...
class JobInfoHeaderCell : UICollectionViewCell {
    ...
    func setupJobImage() {
        addSubview(jobImage)
        jobImage.anchor(top: topAnchor, bottom: bottomAnchor, right: rightAnchor, left: leftAnchor, paddingTop: 0, paddingBottom: -50, paddingRight: 0, paddingLeft: 0, height: 0, width: 0)
    }
    
    //add location label below the picture
    func setupLocationLabel() {
        addSubview(locationLabel)
        locationLabel.anchor(top: nil, bottom: bottomAnchor, right: nil, left: nil, paddingTop: 0, paddingBottom: 0, paddingRight: 0, paddingLeft: 0, height: 0, width: 0)
